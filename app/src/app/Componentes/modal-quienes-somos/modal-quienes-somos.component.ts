...
@Component({
  selector: 'app-modal-quienes-somos',
  templateUrl: './modal-quienes-somos.component.html',
  styleUrls: ['./modal-quienes-somos.component.css']
})
export class ModalQuienesSomosComponent implements OnInit {
